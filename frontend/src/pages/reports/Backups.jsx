...
import { HardDrive, RefreshCcw, Download, PlayCircle, Filter } from 'lucide-react'
...
export default function Backups() {
    ...
    const handleDownload = (id, status) => {
        ...
        // Para o frontend, use a view DRF de download (autenticação via JWT/cookie)
            ...
            <Card>
                <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2 justify-end">
                        ...
                        <Button onClick={handleExecuteBackup} disabled={execLoading || loading}>
                        ...
                        <table className="min-w-full text-sm">
                            ...
                            <tbody>
                                ...
                                {filteredItems.map((b) => {
                                    ...
                                    const trig = b.trigger_type || 'manual'
                                    const typeLabel = trig === 'automatic' ? 'Automático' : 'Manual'
                                    const typeColor = trig === 'automatic' ? 'bg-blue-600' : 'bg-slate-600'
